...
function generateResume(data:{
    ...
    <p><strong>Email:</strong> ${data.email}</p>
     <p><strong>Educaation:</strong> ${data.education}</p>
...
resumeOutput.innerHTML =generateResume({ name, email, education, skills,experience,description});
...
if(editButton){
    editButton.addEventListener(`click`,() =>{
        ...
        (document.getElementById(`skills`)as HTMLInputElement).value=(document.getElementById(`skills`) as HTMLInputElement).value;

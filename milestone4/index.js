...
if (resumeForm && resumeOutput) {
    resumeForm.addEventListener("submit", function (event) {
        ...
        resumeOutput.innerHTML = generateResume({ name: name, email: email, education: education, skills: skills, experience: experience, description: description });
        ...
        if (editButton) {
            editButton.addEventListener("click", function () {
                ...
                document.getElementById("skills").value = document.getElementById("skills").value;
